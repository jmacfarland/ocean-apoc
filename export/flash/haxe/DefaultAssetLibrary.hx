...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/icon_buoy.png", __ASSET__assets_images_icon_buoy_png);
		type.set ("assets/images/icon_buoy.png", AssetType.IMAGE);
		className.set ("assets/images/icon_string.png", __ASSET__assets_images_icon_string_png);
		type.set ("assets/images/icon_string.png", AssetType.IMAGE);
		...
		id = "assets/images/icon_buoy.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/icon_string.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_icon_buoy_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_icon_string_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/icon_buoy.png") #if display private #end class __ASSET__assets_images_icon_buoy_png extends lime.graphics.Image {}
@:image("assets/images/icon_string.png") #if display private #end class __ASSET__assets_images_icon_string_png extends lime.graphics.Image {}
